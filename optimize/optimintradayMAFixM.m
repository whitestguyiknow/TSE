function [obj,tradingTable,dailyTT] = optimintradayMAFixM(x,DSpre,DS1,DS2,sys_par)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fBuyEntry =     @(DS1,i,DS2,k) entryBuyEMAXingM(DS1,i,xEMA,yEMA);  % entry long position
fSellEntry =    @(DS1,i,DS2,k) entrySellEMAXingM(DS1,i,xEMA,yEMA);	% entry short position
